...
const CustomSidebar = ({ openCloseHandler, collapsed }) => {
  ...
  return (
    <div className="hidden lg:flex lg:sticky  lg:top-0 lg:left-0 z-[100]">
      <Sidebar collapsed={collapsed} width="300px" rootStyles={{border:"2px solid #ECECEC"}}>
        ...
        <div className="flex flex-col items-center border-b-2 border-[#ECECEC] py-4  bg-white ">
          <img
            src="/userProfile.png"
            alt="Profile"
            className={`${collapsed ? "w-14 h-auto" : "h-24 w-24"
              } rounded-full mb-4`}
          />
          {!collapsed && (
            <>
        ...
        <Menu className={`${collapsed ? "px-3" : "px-6"} w-full bg-white`}>
          <MenuItem
            ...
            className={`border-b border-gray-200 py-2 flex w-full   
          ...
          <MenuItem
            ...
            className={`border-b border-gray-200 py-2 flex w-full  ${collapsed
          ...
          <MenuItem
            component={<Link to="/call-recording" />}
            icon={<img src="/Chat.svg" alt="" className="icons" />}
            className={`border-b border-gray-200 py-2 flex w-full  ${collapsed
                ? "justify-center items-center"
                : "justify-start items-start"
      ...
      <div className="mt-[20px] ml-[20px] z-20 cursor-pointer">
        <div className="btn w-[40px] h-[40px]" onClick={openCloseHandler}>
          <img
