...
const ActivityAndProductBased = ({ type, onNext, activityDetails, setActivityDetails, onBack }) => {
	...
	return (
		<div className=" border rounded-xl overflow-hidden w-[100%] m:w-[80%] xl:w-[90%] 2xl:w-[70%] min-h-[50vh]">
			<h2 className="text-xl font-semibold mb-8 bg-[#3a643b19] p-6 text-[--primary]">{type === 'Product based' ? 'Product Based Reminders' : 'Activity Based Reminders'}</h2>
			...
			<div className="wrapperDiv p-6">
				...
				<div className="flex w-[100%] justify-center items-center flex-col md:flex-row">
					<div className="flex justify-start items-start w-[100%]  m:w-[50%]  flex-col md:h-[30vh]">
