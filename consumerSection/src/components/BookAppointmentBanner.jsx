...
const BookAppointmentBanner = () => {
    return (
        <div className="bg-gradient-to-l from-[#FFFDF7] to-[#FFF7E2] rounded-lg  p-6 flex flex-col md:flex-row items-center justify-between w-full m:w-[100%] xl:w-[90%] border ">
            <div className="flex items-center justify-between mb-4 md:mb-0 w-full px-[2rem] flex-col md:flex-row">
                ...
                <div className='flexClass flex-col'>
                    ...
                    <p className="text-gray-600 my-2">Schedule your next appointment with our experts</p>
                </div>
