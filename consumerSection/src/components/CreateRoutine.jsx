...
import CreateRoutineProductCard from "./CreateRoutineProductCard";
...
const CreateRoutine = () => {
    ...
    return (
        ...
        >
            <div className="flex  w-full  gap-[10px]   font-poppins text-[15px] font-medium leading-[22.5px] text-[--primary] mt-4">
