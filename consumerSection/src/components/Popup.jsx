      ...
      <div className="bg-white w-full max-w-4xl p-6 rounded-lg shadow-lg">
        ...
        <div className="overflow-y-auto max-h-[30rem]">
          <div className="text-left">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border-b p-2">Video Consultation with Dr. Jude Apana</td>
            ...
            <div className="mb-4">
              <p>If you have any questions or need further assistance, feel free to reach out to us. We look forward to your upcoming appointment.</p>
              <p>Best regards,<br />Amrutam Pharmaceuticals Private Limited Team</p>
            </div>
            <div className="mb-4">
              <p><strong>Our Website:</strong> amrutam.co.in</p>
              <p><strong>For Support:</strong> support@amrutam.co.in</p>
              <p><strong>Our Address:</strong> Amrutam Pharmaceuticals Pvt Ltd., chitragupt ganj, Nai Sadak, Lashkar, Gwalior - 474001</p>
              <p><strong>Contact Us No:</strong> +91 9713719999</p>
            </div>
          </div>
        </div>
      </div>
